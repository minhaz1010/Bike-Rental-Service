...
const createBikeInDatabase = (payload) => __awaiter(void 0, void 0, void 0, function* () {
...
const updateBikeFromDatabase = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield bike_model_1.Bike.findOneAndUpdate({ _id: id }, payload, {
        new: true,
    });
    return result;
});
const deleteASingleBikeFromDatabase = (id) => __awaiter(void 0, void 0, void 0, function* () {
